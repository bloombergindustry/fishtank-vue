<template>
  <fish-tank-base-button
    v-bind="$attrs"
    class="button--outline-dark ft-button--outline-small"
    v-on="$listeners">
    <slot />
  </fish-tank-base-button>
</template>
...
<script lang="ts">
/**
 * FishTankButtonOutlineDarkSmall
 * @deprecated
...
export default Vue.extend({
  ...
  mounted () {
    ...
    console.warn('FishTankButtonOutlineDarkSmall is being deprecated in favor of FishTankButton. * It will be removed from the library in October 2019. Please migrate to FishTankButton.')
  }
})
</script>
